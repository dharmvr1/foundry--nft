...
contract MoodNftIntegrationTest is Test {
    ...
    function testFlipTokenToSad() public {
        string memory ecpectedUri = moodNft.imageUriToTokenUri(SAD_SVG_URI);
        vm.prank(USER);
        moodNft.mintNft();
        ...
        assertEq(
            ...
            keccak256(abi.encodePacked(ecpectedUri))
        );
    }

    function testHaveMood() public {
        vm.prank(USER);
        moodNft.mintNft();
        ...
        assert(uint(moodNft.haveMood(0)) == 1);
    }
}
